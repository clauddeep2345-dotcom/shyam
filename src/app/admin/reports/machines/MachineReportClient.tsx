...
<head>
  <meta charset="utf-8" />
  <title>Machine-wise Production Report: ${startDate} to ${endDate}</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .totals { background: #fdf4ff; border: 1px solid #e9d5ff; border-radius: 8px; padding: 12px 16px; display: flex; gap: 40px; }
    .total-item label { font-size: 10px; text-transform: uppercase; color: #7e22ce; font-weight: 700; display: block; margin-bottom: 2px; }
    .total-item span { font-size: 18px; font-weight: 700; color: #7c3aed; }
    @media print { body { padding: 12px; } }
  </style>
</head>
<body>
  <h1>Machine-wise Production Report</h1>
  <div class="meta">Period: ${startDate} to ${endDate} &nbsp;|&nbsp; Generated on ${dateStr} &nbsp;|&nbsp; ${summary.length} machines</div>
  <table>
    <thead>
      <tr>
        <th>#</th>
